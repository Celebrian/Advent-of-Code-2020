...
To try to debug the problem, they have created a list (your puzzle input) of _passwords_ (according to the corrupted database) and the _corporate policy when that password was set._
